...
//Helpers Function
// convert array like input into a clean array
// when empty or invalid it return empty array Eg.[]
...
export async function createService(req, res) {
  try {
    ...
    } //if the file is present, it will uploaded to services folder in the Cloudinary
