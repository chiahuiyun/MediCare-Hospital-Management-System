    ...
    <div className={contactPageStyles.pageContainer}>
      ...
      <div className={contactPageStyles.gridContainer}>
        <div className={contactPageStyles.formContainer}>
          <h2 className={contactPageStyles.formTitle}>Contect Our Clinic</h2>
          ...
          <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
            ...
            <div>
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                placeholder='Describe your convern briefly...'
                rows={4}
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Kuala Lumpur, Penang, Ipoh, Selangor
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> +601348645849
            </p>
            <p className={contactPageStyles.infoItem}>
          ...
          <iframe
            src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127482.68785497975!2d101.6869895!3d3.1385058999999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc362abd08e7d3%3A0x232e1ff540d86c99!2sKuala%20Lumpur%2C%20Federal%20Territory%20of%20Kuala%20Lumpur!5e0!3m2!1sen!2smy!4v1770973184136!5m2!1sen!2smy'
