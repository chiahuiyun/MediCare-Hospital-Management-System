...
//helpers function
//give output in minutes and according to that, it will manage am:pm
...
//convert (YYYY-MM-DD) to date month year
...
const AddPage = () => {
  ...
  //compute today date in local timezone
  ...
  function addSlotToForm() {
    ...
    //if date is today, then precent from time
    if (slotDate === today) {
      const now = new Date()
