...
import SerDashboard from './pages/ServiceDashboard'
...
function RequireAuth({ children }) {
  ...
  if (!isSignedIn)
    return (
      <div className='min-h-screen font-mono flex items-center justify-center bg-linear-to-b from-emerald-50 via-gray-50 to-emerald-100 px-4'>
